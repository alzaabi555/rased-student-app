import React, { useState } from 'react';import React, { useState } from 'reactName="relative z-10 w-full max-w-sm bg-bgCard border border-borderColor rounded-[2.25rem] p-8 shadow-elevated animate-in fade-in zoom-in duration-500 delay-150">
...
const StudentLogin: React.FC<StudentLoginProps> = ({ onLogin }) => {
  ...
  // استدعاء الكود المحفوظ من الذاكرة فور فتح التطبيق
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // حفظ الكود لتسهيل الدخول القادم
